...
public class GUITools {
	...
	// инструмент для придания группе компонентов одинаковых размеров
	// (минимальных,
	// предпочтительных и максимальных).
	// Компоненты принимают размер самого большого (по ширине) компонента в
	// группе
	...
	// вспомогательный метод для определения позиции максимального элемента
	// массива
